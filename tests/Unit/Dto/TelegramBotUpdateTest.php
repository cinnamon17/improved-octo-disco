...
class TelegramBotUpdateTest extends TestCase
{
    ...
    {
	$stubUpdate = $this->createStub($this->updateDto::class);
	$stubUpdate->method('getMessage')
	    ->willReturn(null);

	$stubUpdate->method('getCallbackQuery')
	    ->willReturn(null);

	$telegramBotUpdate = new TelegramBotUpdate($stubUpdate);
