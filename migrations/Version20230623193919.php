...
final class Version20230623193919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
      ...
      other factors such as cost effectiveness so overall dish ends up being healthy yet economical at same time!. Your response must not exceed 4096 characters in length','chef')");
      ...
      into your evaluation process in order to ensure accuracy. Your response must not exceed 4096 characters in length','doctor')");
      ...
      evaluación para garantizar la precisión. Tu respuesta no debe tener mas de 4096 caracteres','doctor')");
        ...
        Your response must not exceed 4096 characters in length','translator')");
        ...
        target user persona, user\'s pain points to solve, main value propositions, sales & marketing channels, revenue stream sources, cost structures, key activities, key resources,
         key partners, idea validation steps, estimated 1st year cost of operation, and potential business challenges to look for. Your response must not exceed 4096 characters in length','startup')");
